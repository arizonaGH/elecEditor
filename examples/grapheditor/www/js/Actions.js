...
Actions.prototype.init = function()
{
	...
	//wangyanna
    this.addAction('check', function() { ui.checkFile(); }, null, null,  Editor.ctrlKey + '+Shift+C');
    this.addAction('clear', function() { ui.clearCheck(); }, null, null,  Editor.ctrlKey + '+Shift+R');
