 ...
 * create value object for cell
 */
Sidebar.prototype.createObjectForCell = function(type){
...
Sidebar.prototype.addElectronicPalette = function(expanded, id, title, stencilFile, style, ignore, onInit, scale, tags, customFns){
    ...
    //this.addPaletteFunctions('electronic', mxResources.get('electronic'), (expand != null) ? expand : true, fns);
	...
	mxStencilRegistry.loadStencilSet(stencilFile, mxUtils.bind(this, function(packageName, stencilName, displayName, w, h)
	{
		if (ignore == null || mxUtils.indexOf(ignore, stencilName) < 0)
		{
			...
			var name = stencilName.replace(/_/g, ' ');
	...
	fns.push(this.createVertexTemplateEntry('text;html=1;fontColor=#FFFFFF;strokeColor=none;fillColor=none;align=center;verticalAlign=middle;whiteSpace=wrap;rounded=0;',
        40, 20, node, mxResources.get('textarea'), null, null, 'text textbox textarea label'));
...
Sidebar.prototype.addGeneralPalette = function(expand)
{
	...
	var fns = [
	 	this.createVertexTemplateEntry('rounded=0;whiteSpace=wrap;html=1;fillColor=none;dashed=1', 120, 60, '', 'Rectangle', null, null, 'rect rectangle box'),
